...
TYPE
   rLib = record
      cod: integer; //código de Novela,
      nom: string;  //el nombre(titulo)
      gen: string;  //genero,
      pre: real;    //precio,
      end;
...
begin
  ...
  while NOT EOF(data) do begin
    with d do begin
      ...
      writeln(l.cod,' | $ ',l.pre:5:2,' | ',l.gen:25,' | ',l.nom);// mostrar reg a guardar en bin
    end;
...
procedure actualizar(var archivo:fLibros);
  ...
  procedure modificar(var archivo:fLibros);
    ...
    begin
         writeln('Elegir campo del registro a modificar novela c/cod:',r.cod,' "',r.nom,'"  ...');
