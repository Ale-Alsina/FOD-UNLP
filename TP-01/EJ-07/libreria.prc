// ######################## REGISTROS EN FORMATO TXT (STRINGS) ################################# \\
  rTxt = record        //Reg temp para el parseo de valores de los datos del txt
    ...
    pre: string[7];    //precio, 6 digitos 3 enteros 2 decimales y el punto 000.00 al 999.99
...
function validaEnlace(var archivo:fLibros):boolean;
...
function consultaAbrirArchivo(var archivo:fLibros):boolean;
